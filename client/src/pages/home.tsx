...
const inspirationalQuotes = [
  { text: "Success is not final, setbacks are not fatal: it is the courage to continue that counts.", translation: "成功は決定的ではなく、つまずきは致命的ではない。続ける勇気こそが重要なのです。", author: "Winston Churchill", isJapanese: false },
  { text: "うまくいかなかった体験から学ぶことができれば、それは超えるべき壁である。", author: "野口英世", isJapanese: true },
  ...
  { text: "I have not failed. I've just found 10,000 ways that won't work.", translation: "私はあきらめていない。うまくいかない1万通りの方法を発見しただけだ。", author: "Thomas Edison", isJapanese: false },
  ...
  { text: "人生につまずきがないと、真の成長は生まれない。", author: "斎藤茂太", isJapanese: true },
  ...
  { text: "つまずきは成功の種。", author: "日本のことわざ", isJapanese: true },
  ...
  { text: "Success is walking from setback to setback with no loss of enthusiasm.", translation: "成功とは、情熱を失うことなくつまずきからつまずきへと歩んでいくことです。", author: "Winston Churchill", isJapanese: false },
  ...
  { text: "つまずきを恐れるな。つまずきから学べ。", author: "稲盛和夫", isJapanese: true },
